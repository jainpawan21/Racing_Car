...
<body>
    ...
    <div id="name_div" >
       <span>By: PAWAN JAIN</span>
    </div>
    <div id="lov_div">
        Made With <span  id="lov" style="color:red; ">&hearts;</span>
    </div>
    ...
    <div id="follow" >
            <a href="https://www.linkedin.com/in/jainpawan21/" target="_blank">
                <img border="2"  src="http://digitalgrowth.ca/wp-content/uploads/2016/08/linkedin-icon.jpg" width="100" height="100">
            </a>  
    </div>
    <div id="follow1" >
            <a href="https://www.quora.com/profile/Pawan-Jain-155" target="_blank">
                <img border="0"  src="https://cdn4.iconfinder.com/data/icons/flat-icon-social-media/256/Quora.png" width="50" height="50">
            </a>  
    </div>
